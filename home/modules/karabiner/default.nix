    ...
    profiles = [
      {
        complex_modifications = {
          ...
          rules = [
            ...
            {
              description = "Control+Command+Backspace to Lock Screen (macOS 10.13+)";
              manipulators = [
                {
                  from = {
            ...
            {
              description = "map ctrl+space to tab search in Firefox/Zen";
              manipulators = [
                {
                  conditions = [
                    {
            ...
            {
              description = "map cmd+y to history sidebar in Firefox";
              manipulators = [
                {
                  conditions = [
                    {
            ...
            {
              description = "map cmd+shift+y to history window in Firefox";
              manipulators = [
                {
                  conditions = [
                    {
