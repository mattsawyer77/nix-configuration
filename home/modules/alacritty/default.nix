...
let
  ...
  themeConfig = alacrittyThemes."${cfg.theme}";
in
{
  options.custom.alacritty = {
    theme = lib.mkOption {
      ...
      description = "Alacritty color theme name (must match a key in alacrittyThemes).";
    };
    fontFamily = lib.mkOption {
      type = lib.types.str;
      default = "PragmataPro Liga";
      description = "Monospace font family for Alacritty.";
    };
  };
